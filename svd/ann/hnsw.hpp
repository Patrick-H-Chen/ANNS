...
namespace ann {
    ...
    struct GraphSVD : GraphBase {
        ...
        void build_graph(GraphL0<feat_vec_t>& G) {
            ...
            Eigen::MatrixXf X(num_sample_node, code_dimension);
            for(int i = 0; i < num_sample_node; i++){
...
#pragma omp parallel for schedule(dynamic, 1)
    ...
    struct HNSWProductQuantizer4Bits {
        ...
        void train(
            ...
            graph_l0_svd.build_graph(hnsw->graph_l0);
            delete hnsw;
